...
function copyBonuses() {
  ...
  const covers = [
    ...
    ["assets/images/playing-to-win-ebook-cover.jpg", "playing-to-win-ebook.jpg"],
    ["assets/images/playing-to-win-ebook-cover.jpg", "playing-to-win.jpg"],
    ["assets/images/playing-to-win-ebook-cover.jpg", "playing-to-win.png"],
...
function patchEbookLanding(html, filename) {
  ...
  const cover =
    filename === "playing-to-win.html" ? "../covers/playing-to-win-ebook.jpg" : "../covers/x-simplified.png";
