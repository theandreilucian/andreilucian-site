...
export function renderKoeAuthorBio(opts = {}) {
  ...
  return `<section class="koe-author-bio" aria-label="About Andrei Lucian">
    <div class="koe-author-bio-header">
      ...
      <p class="koe-author-bio-tagline">Just a writer building in public.</p>
    </div>
    <div class="koe-author-bio-grid">
      ...
      <div class="koe-author-bio-copy">
        ...
        <p>I'm a writer and ghostwriter obsessed with how people grow online without a viral lottery ticket — the drafts, the replies, and the small wins most creators never post about.</p>
        <p>I spent years shouting into an empty feed before anything moved. Almost three years of daily writing later, I grew to <strong>5,300+ on 𝕏</strong>, <strong>16,300+ on LinkedIn</strong>, <strong>5,500+ on Instagram</strong>, <strong>850+ on Substack</strong>, and <strong>1,100+ on my newsletter</strong> — all organic, no ads.</p>
        <p>Now I document that playbook in my weekly letters and build content systems for founders who'd rather ship than stare at a blank page.</p>
        <p class="koe-author-bio-note"><strong>Want done-for-you writing?</strong> <a href="${p}ghostwriting.html">See my ghostwriting page</a>. <strong>Want to learn the system?</strong> <a href="${escHtml(signupHref)}">Start with the free letters</a> or <a href="${p}index.html#newsletters">read the archive</a>.</p>
      </div>
    </div>
  </section>`;
}
